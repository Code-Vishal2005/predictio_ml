...
st.sidebar.info("👉 Enter the values below and click **Predict** to know wine quality!")

# Main Title & Subheading (Centered)
st.markdown("""
...
st.sidebar.info("""
- 🧠 Built with a Machine Learning model (SVC)
- 📊 Trained on UCI Wine Quality Dataset
- 💡 Aim: Help winemakers identify good wine
""")

st.sidebar.markdown("---")
st.sidebar.markdown("Made with ❤️ by **Vishal Kumar**")
st.sidebar.markdown("📧 Contact: [LinkedIn](https://www.linkedin.com/in/vishalkumar2003/)")

# Final Note
st.markdown("---")
st.info("🔁 Try changing values in the sidebar to test different scenarios.")
